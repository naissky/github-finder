...
import { Users, MapPin, Link2, Twitter, Building2, Mail } from "lucide-react";
  ...
  return (
    <div className="w-full max-w-2xl bg-zinc-950 p-6 rounded-lg shadow-lg text-[#CDD5E0]">
      <div className="flex flex-col text-pretty">
        <div className="flex items-start gap-6">
          ...
          <div className="flex-1">
            <div className="flex flex-col justify-start  items-start">
              ...
              <span className="text-[#4A5567] text-xs">
        ...
        {user.bio && <p className="mt-4 text-[#CDD5E0] max-w-xs">{user.bio}</p>}
      </div>
      ...
      <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <a
            ...
            rel="noopener noreferrer"
            className={
              user.blog ? "hover:underline text-[#3662E3] truncate" : ""
            }
            aria-setsize={20}
          >
